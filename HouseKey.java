 ...
 */
public class HouseKey extends items
{
    ...
    {      
        ...
        if(onScreen){
            ...
            if(Greenfoot.isKeyDown("space")&& player.distanceTOHouseKey <50 && cooldown <0){
