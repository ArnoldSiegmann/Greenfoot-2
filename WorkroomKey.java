...
/**
 * Write a description of class WorkroomKey here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class WorkroomKey extends items
{
    ...
    {      
        ...
        if(onScreen){
            ...
            if(Greenfoot.isKeyDown("space")&& player.distanceTOWorkroomKey <50 && cooldown <0){
                if(MyWorld.slot1isused && cooldown < 0){
                    if(MyWorld.slot2isused && cooldown < 0){
                        if(MyWorld.slot3isused && cooldown < 0){
                            ...
                            if(MyWorld.slot4isused == false){
                                MyWorld.NameOfItem4 = "WorkroomKey";
                                isInInventory = true;
                                NrOfItem = 4;
                        ...
                        if(MyWorld.slot3isused == false){
                            MyWorld.NameOfItem3 = "WorkroomKey";
                            isInInventory = true;
                            NrOfItem = 3;
                    ...
                    if(MyWorld.slot2isused == false){
                        MyWorld.NameOfItem2 = "WorkroomKey";
                        isInInventory = true;
                        NrOfItem = 2;
                ...
                if(MyWorld.slot1isused == false){
                    MyWorld.NameOfItem1 = "WorkroomKey";
                    isInInventory = true;
                    NrOfItem = 1;
