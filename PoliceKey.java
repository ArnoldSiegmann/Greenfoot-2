...
/**
 * Write a description of class PoliceKey here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class PoliceKey extends items
{
    ...
    {      
        ...
        if(onScreen){
            ...
            if(Greenfoot.isKeyDown("space")&& player.distanceTOPoliceKey <50 && cooldown <0){
