 ...
 */
public class CarKey extends items
{
    ...
    {      
        ...
        if(onScreen){
            ...
            if(Greenfoot.isKeyDown("space")&& player.distanceTOCarKey <50 && cooldown <0){
