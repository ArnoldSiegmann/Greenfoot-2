...
/**
 * Write a description of class HouseKey here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class GardenScissors extends items
{
    ...
    {      
        ...
        if(onScreen){
            ...
            if(Greenfoot.isKeyDown("space")&& player.distanceTOGardenScissors <50 && cooldown <0){
                if(MyWorld.slot1isused && cooldown < 0){
                    if(MyWorld.slot2isused && cooldown < 0){
                        if(MyWorld.slot3isused && cooldown < 0){
                            ...
                            if(MyWorld.slot4isused == false){
                                MyWorld.NameOfItem4 = "Garden Scissors";
                                isInInventory = true;
                                NrOfItem = 4;
                        ...
                        if(MyWorld.slot3isused == false){
                            MyWorld.NameOfItem3 = "Garden Scissors";
                            isInInventory = true;
                            NrOfItem = 3;
                    ...
                    if(MyWorld.slot2isused == false){
                        MyWorld.NameOfItem2 = "Garden Scissors";
                        isInInventory = true;
                        NrOfItem = 2;
                ...
                if(MyWorld.slot1isused == false){
                    MyWorld.NameOfItem1 = "Garden Scissors";
                    isInInventory = true;
                    NrOfItem = 1;
