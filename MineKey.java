...
/**
 * Write a description of class MineKey here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class MineKey extends items
{
    ...
    {      
        ...
        if(onScreen){
            ...
            if(Greenfoot.isKeyDown("space")&& player.distanceTOMineKey <50 && cooldown <0){
