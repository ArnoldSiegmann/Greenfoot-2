...
/**
 * Write a description of class CabinetKey here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class CabinetKey extends items
{
    ...
    static boolean addtoinventory = false;
    ...
    {      
        ...
        if(onScreen){
            ...
            if(Greenfoot.isKeyDown("space")&& player.distanceTOCabinetKey <50 && cooldown <0){
                if(MyWorld.slot1isused && cooldown < 0){
                    if(MyWorld.slot2isused && cooldown < 0){
                        if(MyWorld.slot3isused && cooldown < 0){
                            ...
                            if(MyWorld.slot4isused == false){
                                MyWorld.NameOfItem4 = "Cabinet Key";
                                isInInventory = true;
                                NrOfItem = 4;
                        ...
                        if(MyWorld.slot3isused == false){
                            MyWorld.NameOfItem3 = "Cabinet Key";
                            isInInventory = true;
                            NrOfItem = 3;
                    ...
                    if(MyWorld.slot2isused == false){
                        MyWorld.NameOfItem2 = "Cabinet Key";
                        isInInventory = true;
                        NrOfItem = 2;
                ...
                if(MyWorld.slot1isused == false){
                    MyWorld.NameOfItem1 = "Cabinet Key";
                    isInInventory = true;
                    NrOfItem = 1;
